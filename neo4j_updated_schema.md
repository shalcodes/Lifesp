...
| `sourceFile` | No | String | Originating file name; represents `(:ProcessedDataOutput)-[:CONTAINS_OBSERVATION]->(:MethylationObservation)` | `jhu-usc.edu_BRCA.txt` | Metadata |
...
| `DERIVED_FROM_OUTPUT` | (No properties) | No | None | Inverse structural link. |  |
